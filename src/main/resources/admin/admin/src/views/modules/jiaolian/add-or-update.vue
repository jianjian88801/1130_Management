        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="所获荣誉" prop="rongyuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.rongyuContent" label="所获荣誉" prop="rongyuContent">
                            <span v-html="ruleForm.rongyuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="教练详细介绍" prop="jiaolianContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaolianContent" label="教练详细介绍" prop="jiaolianContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaolianContent: [
                              { required: true, message: '教练详细介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
